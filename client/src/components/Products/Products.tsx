          ...
          <article className="shadow-md" key={clothe.id}>
            <figure>
              <image className=" relative">
                ...
                <button onClick={() => addToCart(clothe)} className="absolute top-2 right-2 -bg--color-light-grey-violet rounded-full p-2"> <img src={bag_icon} alt="bag icon" className="w-4" />  </button>
